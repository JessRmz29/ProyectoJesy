...
<table width="955" border="0" align="center" cellpadding="4" cellspacing="0">
  <tr>
    <td height="26"><p><img src="imagenes/mapaweb.gif" alt="Mapa de la web brcmedia.com" width="19" height="15" border="0" id="Image1"> <a href="mapaweb.html" class="mbrocos" title="Mapa de la web brcmedia.com">Mapa Web</a> <font color="#4C4639">/</font>&nbsp;<a class="mbrocos" href="avisolegal/avisolegal.html" title="Aviso Legal de BRCmedia">Aviso Legal </a><font color="#4C4639">/</font> <strong><font color="#D6D0C4">&copy;</font></strong><font color="#D6D0C4"> mart&iacute;n brocos. Telf:</font> <font color="#4C4639">977 11 09 93</font> <font color="#4C4639">/</font><font color="#D4D0C4"> M&oacute;vil:</font> <font color="#4C4639">636 84 25 10</font> </p></td>
    ...
    <td><table width="915" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="266" valign="top">&nbsp;<br>
            ...
            <table width="260" border="0" cellpadding="4" cellspacing="0">
              <tr>
                <td><img src="imagenes/flecha.gif" alt="Ver más noticias brcmedia.com" width="22" height="13"><a href="noticias/noticias.html" class="brcenlaces" title="Ver producto 3">Ver más noticias...</a></td>
              </tr>
            </table>
            <p>&nbsp;</p>
          <table width="260" border="0" cellpadding="0" cellspacing="0">
          ...
          <table width="260" border="0" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <td>Teléfono: <font color="#000000">636 84 25 10</font></td>
            </tr>
            <tr>
          ...
          <table width="260" border="0" cellpadding="0" cellspacing="0">
            <tr>
              <td><p><strong>Enlaces patrocinados</strong>: <br>
